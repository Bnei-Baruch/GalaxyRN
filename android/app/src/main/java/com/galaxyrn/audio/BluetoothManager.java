...
public class BluetoothManager {
  ...
  private final AudioDeviceModule apprtcAudioManager;
  @Nullable
  ...
  /** Construction. */
  public static BluetoothManager create(Context context, AudioDeviceModule audioManager) {
    return new BluetoothManager(context, audioManager);
  }
  protected BluetoothManager(Context context, AudioDeviceModule audioManager) {
    Log.d(TAG, "ctor");
    AudioHelper.checkIsOnMainThread();
